# 🎛️ Core Syntax & Control Flow

> Part of [Go Programming](https://stanza.dev/courses/go)

Mastering variables, loops, and control structures.

## Lessons

1. [Variables & Basic Types](./1-and-types.md)
2. [Numbers, Strings & Booleans](./2-basic-types.md)
3. [Loops & Branching](./3-and-branches.md)
4. [Switch Statements](./4-switch-statement.md)
