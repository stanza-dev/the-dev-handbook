...
1. [What is Structured Concurrency?](./1-structured-intro.md)
2. [TaskGroups (Python 3.11+)](./2-task-groups.md)
3. [Exception Groups in Concurrent Code](./3-exception-groups.md)
4. [TaskGroup Patterns](./4-taskgroup-patterns.md)
