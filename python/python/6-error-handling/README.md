...
1. [Exception Fundamentals](./1-exception-basics.md)
2. [Raising & Creating Exceptions](./2-raising-exceptions.md)
3. [Context Managers](./3-context-managers.md)
4. [Exception Groups (Python 3.11+)](./4-exception-groups.md)
