...
- [MDN: AbortController](https://developer.mozilla.org/en-US/docs/Web/API/AbortController) — AbortController API reference and usage patterns
- [MDN: AbortSignal](https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal) — AbortSignal reference including timeout and any static methods
