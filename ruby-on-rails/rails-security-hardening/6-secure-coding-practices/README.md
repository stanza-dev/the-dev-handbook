...
Apply security best practices throughout your codebase.

## Lessons

1. [Strong Parameters](./1-strong-parameters.md)
2. [Secrets Management](./2-secrets-management.md)
3. [Security Headers](./3-security-headers.md)
